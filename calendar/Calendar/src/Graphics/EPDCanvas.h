...
class EPDCanvas : public GFXcanvas1 {
  public:
    ...
    void drawTextRect(int16_t x, int16_t y, uint16_t w, uint16_t h, const String &str);
    void drawTimeRect(int16_t x, int16_t y, uint16_t hs, uint16_t ms, uint16_t he, uint16_t me);
};
#endif
